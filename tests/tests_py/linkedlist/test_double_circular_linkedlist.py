"""
Test Double Circular Linkedlist

The following script contains all the code to test
all the features from Double Circular Linkedlists.
"""
import unittest

from dsa_py.linkedlist.double_circular_linkedlist import DoubleCircularLinkedlist


class TestDoubleCircularLinkedlist(unittest.TestCase):
    
    def setUp(self) -> None:
        self.linkedlist = DoubleCircularLinkedlist()
